...
// (If you still want BoardInspection somewhere else, keep its import and a section for it)
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col">
      <main className="flex-grow">
        ...
        {/* Product Grids (replaces the old VerticalTabs module) */}
        <section className="bg-white py-10">
          <div className="w-[80%] mx-auto px-4 space-y-10">
            <ProductGrid
              title="Trending New Parts"
              mode="new"
              seedQuery="" // optional: "board", "motor", etc.
              limit={12}
            />
            <ProductGrid
              title="Refurbished Deals"
              mode="refurb"
              seedQuery="" // optional: "board", "control", etc.
              limit={12}
            />
          </div>
        </section>
