...
export default function HeaderMenu() {
  ...
  return (
    <>
      {/* DESKTOP/TABLET (>= pad) — row of menu actions + hover dropdowns via portal */}
              ...
              <div className="flex flex-col pad:flex-row gap-6">
                <div className="w-full pad:w-1/3 space-y-2">
                  ...
                  <p>
                    ...
                    will be shipped the{" "}
                    <strong>same business day</strong>. Orders placed
                    after the cutoff time will be shipped the{" "}
                ...
                <div className="w-full pad:w-1/3 space-y-2">
                  ...
                  <ul className="list-disc pl-5">
                    ...
                    <li>
                      ...
                      Additional customs duties or taxes may apply.
                    </li>
                  </ul>
                ...
                <div className="w-full pad:w-1/3 space-y-2">
                  ...
                  <p>
                    This policy applies only to international
                    orders—any orders shipped outside the United States,
                    including Canada, Mexico, and other countries.
                  </p>
                  ...
                  <p>
                    The receiver is responsible for all duties,
                    tariffs, and taxes. We do not collect these at
                    checkout. We will never undervalue a shipment or
                    mark it as a gift.
                  </p>

                  <h6 className="font-semibold">
                    Refused Deliveries &amp; No Refunds
                  </h6>
                  <p>
                    If duties/tariffs are refused, we will instruct the
                    carrier to dispose of the shipment. No refund will
                    be issued.
                  </p>

                  <h6 className="font-semibold">
                    Delivery Times &amp; Customs Delays
                  </h6>
                  <p>
                    International shipping times vary; customs
                    clearance may cause delays beyond our control.
                  </p>
                  ...
                  <p>
                    For low-value items with disproportionately high
                    shipping, we may reach out to discuss options
                    before proceeding.
                  </p>
              ...
              <div className="flex flex-col pad:flex-row gap-6">
                <div className="w-full pad:w-1/3 space-y-2">
                  ...
                  <ul className="list-disc pl-5">
                    ...
                    <li>
                      <strong>Condition:</strong> Items must be
                      unused, unmodified, and in original condition
                      with all packaging, labels, and components.
                    </li>
                    <li>
                  ...
                  <ul className="list-disc pl-5">
                    ...
                    <li>
                      Installed, modified, or damaged items due to
                      improper installation/handling.
                    </li>
                    <li>
                      Items missing essential components or original
                      packaging (may be refused or incur a restocking
                      fee).
                    </li>
                  </ul>
                </div>
                ...
                <div className="w-full pad:w-1/3 space-y-2">
                  ...
                  <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <li>
                      Include your full name, order date, reason for
                      return, and photos (if applicable).
                    </li>
                    <li>
                      Our team will review your request within{" "}
                      <strong>3 business days</strong> and provide
                      return instructions.
                    </li>
                  </ol>
                  ...
                  <ul className="list-disc pl-5">
                    <li>
                      If <strong>our error</strong> (wrong/defective
                      item), we cover return shipping.
                    </li>
                    <li>
                      If <strong>customer error</strong> (wrong item,
                      changed mind), customer covers return shipping.
                    </li>
                    <li>
                      Items must be securely packed to prevent
                      transit damage and include the issued RAN on
                      the package.
                    </li>
                  </ul>
                </div>
                ...
                <div className="w-full pad:w-1/3 space-y-2">
                  ...
                  <ul className="list-disc pl-5">
                    <li>
                      ...
                      <strong>5–7 business days</strong> after item is
                    ...
                    <li>
                      Shipping fees are non-refundable unless the
                  ...
                  <p>
                    Appliance Part Geeks reserves the right to refuse
                    any return that does not meet our policy
                    guidelines or is deemed fraudulent.
                  </p>
            ...
            >
              <div className="flex flex-col pad:flex-row gap-6">
                <div className="w-full pad:w-1/2 space-y-2">
                  ...
                  <p>
                    Appliance repairs are time-sensitive, and at
                    Appliance Part Geeks, we prioritize fast and
                    efficient shipping. If you need to cancel your
                  ...
                  <p>
                    Yes! Orders canceled before shipment will receive
                    a <strong>full refund</strong>. Due to quick
                    processing times, reach out as soon as possible
                ...
                <div className="w-full pad:w-1/2 space-y-2">
                  ...
                  <p>
                    If you received a shipping confirmation email,
                    your order is already on its way and can’t be
                    canceled. Once the item arrives, you may{" "}
                    <strong>
            ...
            >
              <div className="flex flex-col pad:flex-row gap-6">
                <div className="w-full pad:w-1/2 space-y-2">
                  ...
                  <p>
                    Your appliance’s model number is on its serial
                    tag, which lists both the model and serial
                    numbers. The tag’s location varies by appliance
                    type and brand.
                  </p>
                  ...
                  <ul className="list-disc pl-5">
                    <li>
                      <strong>Front Load:</strong> Inside the door
                      frame.
                    </li>
                    <li>
                      <strong>Top Load:</strong> Under the lid at the
                      back, bottom front left of the cabinet, side
                      panels, or back of the console (use a mirror if
                      needed).
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc pl-5">
                    <li>
                      Behind the door on the dryer frame.
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc pl-5">
                    <li>
                      <strong>Freestanding:</strong> On the oven frame
                      behind the oven door or pull-out drawer.
                    </li>
                    <li>
                      <strong>Slide-In:</strong> Behind the oven door,
                      bottom right side of the cabinet, or behind the
                      pull-out drawer.
                    </li>
                    <li>
                      <strong>Built-In Wall Ovens:</strong> On the
                      frame behind the oven door; some models place it
                      on the casing (may require removal from the
                      wall).
                    </li>
                    <li>
                ...
                <div className="w-full pad:w-1/2 space-y-2">
                  ...
                  <ul className="list-disc pl-5">
                    <li>
                      Inside the refrigerator section on inner walls.
                    </li>
                    <li>
                      Behind the kick panel at the bottom.
                    </li>
                    <li>
                      <strong>Chest Freezers:</strong> On the front
                  ...
                  <ul className="list-disc pl-5">
                    <li>
                      Inside the microwave on the left wall.
                    </li>
                    <li>
                      Outside casing: Bottom side.
                    </li>
                    <li>
                      <strong>Over-the-range:</strong> Underneath
                      towards the back.
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc pl-5">
                    <li>
                      Inside the door on the left or right front
                      edge, or on the side of the door.
                    </li>
                  </ul>
                </div>
              </div>
      ...
      {/* MOBILE (< pad) — hamburger menu + accordions */}
                ...
                {[
                  {
                    ...
                    content: (
                      <div className="space-y-3 text-sm text-white/90">
                        <p>
                          We see thousands of recovered refrigerators
                          on a daily basis. Reach out to us and we
                          will hunt it down.
                        </p>
                        <form
                          className="space-y-3"
                    ...
                    content: (
                      <div className="space-y-2 text-sm text-white/90">
                        <p>
                          ...
                          <strong>one business day</strong>. Orders
                          before cutoff ship the{" "}
                          <strong>same day</strong>; after cutoff ship
                          the <strong>next business day</strong>.
                        </p>
                        <p>
                        ...
                        <ul className="list-disc pl-5 space-y-1">
                          <li>
                            <strong>Address Changes:</strong> Not
                            possible after placing the order.
                          </li>
                          <li>
                            <strong>Undeliverable Packages:</strong>{" "}
                            Buyer covers any reship costs.
                          </li>
                          <li>
                            <strong>International:</strong>{" "}
                            Duties/taxes may apply; delivery times
                            vary.
                          </li>
                        </ul>
                      </div>
                    ...
                    content: (
                      <div className="space-y-2 text-sm text-white/90">
                        <ul className="list-disc pl-5 space-y-1">
                          ...
                          <li>
                            <strong>RAN required</strong> before
                            returning any item.
                          </li>
                          <li>
                            “For Parts Only”, installed, altered, or
                            incomplete items are non-returnable.
                          </li>
                        </ul>
                        <p>
                          Start a return:{" "}
                  ...
                  },
                  {
                    ...
                    content: (
                      <div className="space-y-2 text-sm text-white/90">
                        ...
                        <p>
                          <strong>Before shipping:</strong> full
                          refund.
                        </p>
                        <p>
                          <strong>After shipping:</strong> cannot
                          cancel; you may return after delivery for a
                          refund.
                        </p>
                      </div>
                    ),
                  },
                  {
                    ...
                    content: (
                      <div className="space-y-2 text-sm text-white/90">
                        <p>
                          Your appliance’s model number is on its
                          serial tag (lists model + serial). Location
                          varies by appliance.
                        </p>
                        ...
                        <ul className="list-disc pl-5">
                          <li>
                            <strong>Front Load:</strong> Inside the
                            door frame.
                          </li>
                          <li>
                            <strong>Top Load:</strong> Under lid
                            (back), bottom front left of cabinet, side
                            panels, or back of console (mirror may
                            help).
                          </li>
                        </ul>
                        ...
                        <p className="font-semibold mt-2">
                          ...
                          <ul className="list-disc pl-5">
                            <li>
                              <strong>Freestanding:</strong> Oven
                              frame behind oven door or pull-out
                              drawer.
                            </li>
                            <li>
                              <strong>Slide-In:</strong> Behind door,
                              bottom right of cabinet, or behind the
                              pull-out drawer.
                            </li>
                            <li>
                              <strong>Wall Ovens:</strong> Frame
                              behind door; sometimes on the casing
                              (may require removal).
                            </li>
                            <li>
                              <strong>Cooktops:</strong> Underneath
                              or on the sides of the metal cabinet.
                            </li>
                          </ul>
                        ...
                        <ul className="list-disc pl-5">
                          <li>
                            Inside fridge on inner walls.
                          </li>
                          <li>
                            Behind the kick panel at the bottom.
                          </li>
                          <li>
                            <strong>Chest Freezers:</strong> Front
                            bottom or side of cabinet.
                          </li>
                        </ul>
                        ...
                        <ul className="list-disc pl-5">
                          ...
                          <li>
                            <strong>Over-the-range:</strong>{" "}
                            Underneath toward the back.
                          </li>
                        </ul>
                        ...
                        <ul className="list-disc pl-5">
                          <li>
                            Inside the door on the left/right front
                            edge, or on the door side.
                          </li>
                        </ul>
                      </div>
                    ),
