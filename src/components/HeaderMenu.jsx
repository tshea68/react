...
const HeaderMenu = () => {
  return (
    <nav className="hidden md:flex flex-col justify-end pb-2">
      <div className="flex justify-center space-x-10 text-lg font-semibold text-white relative z-40 pb-2">
        {/* Rare Part Request */}
        <div className="group relative inline-block">
          ...
          <div className="fixed left-1/2 -translate-x-1/2 top-[5rem] pointer-events-none group-hover:pointer-events-auto opacity-0 group-hover:opacity-100 transform group-hover:translate-y-2 group-hover:-translate-y-0 transition-all duration-600 ease-in-out group-hover:flex flex-row gap-6 bg-white text-black border p-4 w-[64rem] z-50 max-h-[36rem] overflow-y-auto text-sm shadow-lg">
            <div className="w-full md:w-1/2 space-y-4">
              ...
              <p>We see thousands of recovered refrigerators on a daily basis. Reach out to us and we will hunt it down.</p>
            </div>
            <div className="w-full md:w-1/2 space-y-3">
              <form className="space-y-3" method="POST" action="mailto:support@appliancepartgeeks.com" encType="text/plain">
        ...
        <div className="group relative inline-block">
          ...
          <div className="fixed left-1/2 -translate-x-1/2 top-[5rem] pointer-events-none group-hover:pointer-events-auto opacity-0 group-hover:opacity-100 transform group-hover:translate-y-2 group-hover:-translate-y-0 transition-all duration-600 ease-in-out group-hover:flex flex-row gap-6 bg-white text-black border p-4 w-[64rem] z-50 max-h-[36rem] overflow-y-auto text-sm shadow-lg">
            <div className="w-full md:w-1/3 space-y-2">
              ...
              <p>At <strong>A-Z Appliance Parts</strong>, we prioritize fast and efficient shipping. All orders are processed and shipped within <strong>one business day</strong>.</p>
              ...
              <p>Contact the carrier with your tracking number. Still need help? Email <a className="custom-link" href="mailto:support@appliancepartgeeks.com">support@appliancepartgeeks.com</a></p>
            </div>
            <div className="w-full md:w-1/3 space-y-2">
        ...
        <div className="group relative inline-block">
          ...
          <div className="fixed left-1/2 -translate-x-1/2 top-[5rem] pointer-events-none group-hover:pointer-events-auto opacity-0 group-hover:opacity-100 transform group-hover:translate-y-2 group-hover:-translate-y-0 transition-all duration-600 ease-in-out group-hover:flex flex-row gap-6 bg-white text-black border p-4 w-[64rem] z-50 max-h-[36rem] overflow-y-auto text-sm shadow-lg">
            <div className="w-full md:w-1/3 space-y-2">
              <p>
                Appliance repairs are time-sensitive. We ship fast. To cancel or change an order, contact us immediately at <a href="mailto:support@a-zapplianceparts.com">support@a-zapplianceparts.com</a>.
              </p>
            </div>
            <div className="w-full md:w-1/3 space-y-2">
